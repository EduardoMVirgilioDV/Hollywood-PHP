<div class="container-fluid">
    <div class="d-flex vh-100 align-items-center flex-column justify-content-center">
        <h2 class="display-1 text-dark bg-light font-weight-bold px-4 text-uppercase mb-4 rounded-pill"> top 5 actors </h2>
        <div class="card-deck">
